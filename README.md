# Hi, I'm Medha Masanam 👋

**Machine Learning Engineer | Time-Series Forecasting | Operational Oceanography**

I specialize in building predictive models for complex environmental data. Recently, I developed a 4-Stage Post-Processing Pipeline for Sea Surface Temperature forecasting at INCOIS, achieving a 0.108°C RMSE against Argo float data using the Moirai foundation model.

### 💻 Engineering Focus
- **Machine Learning:** PyTorch, Time-Series Forecasting (LSTM, N-BEATS, Foundation Models)
- **Data Engineering:** NumPy, Pandas, NetCDF, SciPy
